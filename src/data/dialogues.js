export const DIALOGUES = [
...

  {
    ...
    lines: [
      ...
      {
        speaker: "ב",
        he: "בַּבֹּקֶר אֲנִי אוֹכֵל וְשׁוֹתֶה קָפֶה.",
        tr: "Ba-boker ani ojel ve-shote kafe.",
        es: "Por la mañana como y bebo café.",
      },
      {
        speaker: "א",
        he: "וְאַחַר כָּךְ?",
      ...
      {
        speaker: "ב",
        he: "אֲנִי עוֹבֵד כָּל הַיּוֹם. הָעֲבוֹדָה קָשָׁה.",
        tr: "Ani oved kol ha-yom. Ha-avoda kasha.",
        es: "Trabajo todo el día. El trabajo es duro.",
      },
      {
        speaker: "א",
        he: "בָּעֶרֶב אַתָּה לוֹמֵד עִבְרִית?",
        tr: "Ba-erev ata lomed ivrit?",
        es: "¿Por la tarde estudias hebreo?",
      },
      {
        speaker: "ב",
        he: "כֵּן! כִּי אֲנִי אוֹהֵב אֶת הַשָּׂפָה.",
        tr: "Ken! Ki ani ohev et ha-safa.",
        es: "¡Sí! Porque me gusta el idioma.",
      },
    ],
    questions: [
      {
        q: "¿Qué bebe el segundo hablante por la mañana?",
        options: ["מַיִם", "תֵּה", "קָפֶה", "עִבְרִית"],
        answer: 2,
      },
      {
        q: "¿Por qué estudia hebreo el segundo hablante?",
        options: ["כִּי הוּא עוֹבֵד", "כִּי הוּא אוֹהֵב אֶת הַשָּׂפָה", "כִּי הוּא רוֹצֶה לָלֶכֶת", "כִּי יֵשׁ לוֹ זְמַן"],
        answer: 1,
      },
    ],
  },
